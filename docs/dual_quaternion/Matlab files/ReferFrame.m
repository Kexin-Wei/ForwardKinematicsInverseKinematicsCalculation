classdef ReferFrame
    ...
    properties
        ...
        w % angular velocity
        v % linear velocity
        a % linear accelaration
        aa % angular accelaration
        q  % quaternion
        dq % dual quaternion
    ...
    methods
        %====================
        function c=ReferFrame(r,w,v,a,aa,q)
            % define function
            c.r=VQ(r);
            c.w=VQ(w);
            c.v=VQ(v);
        ...
        function rcYX_Y=FrameSwap(cYX_X)
            ...
            rcYX_Y.a=FrameS(cYX_X.r,cYX_X.q);
            rcYX_Y.aa=FrameS(cYX_X.r,cYX_X.q);
